 ...
 *
 * @param {TailEvent} tailEvent - The tail event containing logs and exceptions
 * @param {Env} env - Environment variables
 * @param {object} options
 * @param {typeof globalThis.fetch} [options.fetch]
 * @returns {Promise<void>}
 */
export async function handleTailEvent(
    tailEvent,
    env,
    { fetch = global.fetch } = {},
) {
    ...
    // TrailEvent events array contains logs and exceptions
